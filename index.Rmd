...
The first part of this tutorial entailed an introduction to rMarkdown's capabilities and getting everyone's personal computers to generate a default template .html file. We will get everyone up to speed in the following slides. Specifically, after this you should be able to:
...
## Let's try the default HTML document again!
...
The process to create a new rMarkdown file: File $\rightarrow$ New File $\rightarrow$ R Markdown
...
This is an R package that provides document formats to produce complete APA manuscripts from RMarkdown files (either PDF or Word), it also has helper functions that facilitate reporting statistics, tables, and plots. 
